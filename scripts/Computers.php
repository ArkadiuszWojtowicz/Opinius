...
$opinie = $db->displayReviews("SELECT nick, name, category, review from items WHERE category= 'Komputery i laptopy' ORDER BY `id-item` DESC"  , array("nick","name","category","review"));
