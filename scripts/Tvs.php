...
$opinie = $db->displayReviews("SELECT `id-item`, nick, name, category, review from items WHERE category= 'Telewizory' ORDER BY `id-item` DESC"  , array("id-item","nick","name","category","review"));
