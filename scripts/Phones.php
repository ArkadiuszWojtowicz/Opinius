...
$opinie = $db->displayReviews("SELECT nick, name, category, review from items WHERE category= 'Telefony i smartfony' ORDER BY `id-item` DESC"  , array("nick","name","category","review"));
