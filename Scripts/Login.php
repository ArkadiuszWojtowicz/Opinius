...
if (filter_input(INPUT_POST, "zaloguj")) {
    ...
    $contentAdmin = ""; // aby nie wyswietlał sie blad niezdefiniowania zmiennej w seksji logowanie
    $contentLOG = ""; // aby nie wyswietlał sie blad niezdefiniowania zmiennej w seksji logowanie
    $content = '';
